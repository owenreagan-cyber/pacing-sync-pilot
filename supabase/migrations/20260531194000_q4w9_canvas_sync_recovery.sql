...
-- Ensures pacing + deployment tables contain Q4W9 data and are ready for redeploy:
-- - pages (including front-page refresh path)
-- - assignment creation (including Math Study Guide synthetic rows)
-- - scheduled reminder announcements

-- Keep annual pacing master aligned with Q4W9 source pacing.
...
-- Keep active week set to Q4W9 so app and wizard pick this week by default.
...
BEGIN
  ...
  FROM public.weeks
  WHERE quarter = 'Q4' AND week_num = 9;
  ...
  -- Force assignment/page regeneration for Q4W9.
  ...
  -- Rebuild Q4W9 reminder announcements in a format Friday auto-publish can send.
